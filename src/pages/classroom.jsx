...
import Sidebar from "./sidebar_dark.jsx"; // Always use sidebar
      ...
      <div className="flex-1 flex flex-col transition-all duration-300 ml-64">
        ...
        <div className="bg-black border-b border-gray-700 px-8 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {/* Sun icon toggle button - left of calendar */}
            <button
        ...
        {/* Tabs */}
        <div className="flex gap-8 px-8 pt-6 border-b border-gray-700">
          <button className="pb-2 border-b-2 border-white font-semibold text-base text-white">Stream</button>
          <button className="pb-2 text-gray-400 text-base">Classwork</button>
          <button className="pb-2 text-gray-400 text-base">People</button>
        ...
        <div className="flex gap-8 px-8 py-8">
          {/* Left card */}
          <div className="bg-gray-900 rounded-xl p-8 w-80 flex-shrink-0">
            <h2 className="text-3xl font-bold mb-2 text-white">Physics</h2>
            <p className="text-lg text-gray-400 mb-6">Xth C</p>
            <div className="bg-black rounded-lg p-4 mb-4 border border-gray-800">
              <h3 className="text-lg font-semibold mb-2 text-white">Upcoming</h3>
              <p className="text-gray-300 mb-2">Woohoo, no work due soon!</p>
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
              <div className="flex items-center gap-4 mb-2">
                ...
                <span className="font-semibold text-base text-white">ABC Ma'am</span>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="bg-black text-white px-4 py-2 rounded-lg flex-1 outline-none border border-gray-800 text-base"
                />
