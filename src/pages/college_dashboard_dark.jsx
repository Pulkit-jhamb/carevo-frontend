        ...
        <div className="bg-black px-8 py-5 flex items-center justify-between">
          <div className="relative flex-1 max-w-md">
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-white placeholder-gray-400"
            />
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="bg-black rounded-xl p-6">
                    ...
                    <h2 className="text-xl font-bold text-white mb-2">{userName || "User"}</h2>
                    <p className="text-sm text-gray-300 mb-1">College: {user?.institute || "Not specified"}</p>
                    <div className="flex items-center gap-1 mb-1">
                      <span className="text-sm text-gray-300">Year:</span>
                      <span className="text-sm font-medium text-white">{user?.year || "Not specified"}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <span className="text-sm text-gray-300">Major:</span>
                      <span className="text-sm font-medium text-white">{user?.major || "Not specified"}</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-black rounded-xl p-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="relative group">
                        ...
                        <div className="absolute right-0 top-8 bg-gray-800 rounded-lg shadow-lg py-2 w-32 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                          <button 
                  ...
                  <div className="bg-black rounded-xl p-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="relative group">
                        ...
                        <div className="absolute right-0 top-8 bg-gray-800 rounded-lg shadow-lg py-2 w-40 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                          <button 
                      ...
                      {workExperience.length > 0 ? (
                        workExperience.slice(0, 2).map((experience, index) => (
                          <div key={experience.id} className="flex items-center justify-between">
                            <p className="text-sm text-gray-300 truncate">{experience.title}</p>
                            <button 
                        ...
                        <p className="text-sm text-gray-500">No experience yet</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="bg-black rounded-xl p-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <h3 className="text-lg font-semibold text-white">Overall CGPA</h3>
                        <p className="text-sm text-gray-400">Out of 10.0 • {totalCredits} Total Credits</p>
                      </div>
                      <div className="text-right">
                        <div className="text-4xl font-bold text-white">{overallCgpa.toFixed(2)}</div>
                  ...
                  <div className="bg-black rounded-xl p-6">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-lg font-semibold text-white">Semester-wise CGPA</h3>
                      <button 
                      ...
                      {semesters.length > 0 ? (
                        <>
                            ...
                            {semesters.map((semester, index) => (
                              <div key={semester.id} className="flex flex-col items-center group relative">
                                ...
                                <div className="mt-2 text-center">
                                  <div className="text-xs text-white font-medium">{semester.sgpa}</div>
                                  <div className="text-xs text-gray-400">Sem {semester.semester_number}</div>
                          ...
                          <div className="flex items-center justify-center gap-6 text-sm">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-gray-400">SGPA (out of 10)</span>
                            </div>
                          </div>
                        </>
                      ) : (
                        <div className="flex items-center justify-center h-40">
                          <div className="text-center">
                            <div className="text-gray-400 mb-2">No semester data available</div>
                            <button 
                              onClick={() => setShowSemesterModal(true)}
                              className="px-4 py-2 bg-gray-600 text-white rounded-lg text-sm font-medium hover:bg-gray-700 transition-colors"
                            >
                      ...
                      <div className="relative h-36 mb-6">
                        <svg className="w-full h-full overflow-visible" viewBox="0 0 350 120">
                          ...
                          {[40, 90, 140, 190, 240, 290].map((x, i) => (
                            <g key={i}>
                              <circle cx={x} cy={[90, 70, 75, 60, 55, 50][i]} r="4" fill="#6b7280" />
              ...
              <div className="space-y-6">
                ...
                <div className="bg-black rounded-xl p-6">
                      ...
                      for (let day = 1; day <= daysInMonth; day++) {
                        ...
                        days.push(
                          <div 
                            ...
                            className={`text-center text-sm py-2 cursor-pointer hover:bg-gray-800 rounded transition-colors ${
                              isSelected ? 'bg-gray-600 text-white' : 
                              isToday ? 'bg-gray-500 text-white' : 'text-white hover:text-gray-300'
                            }`}
                          >
                            {day}
                          </div>
                  ...
                  <button 
                    ...
                    className="w-full flex items-center justify-center gap-2 py-2 text-sm text-gray-400 hover:text-white"
                  >
                  ...
                  <div className="space-y-3">
                    {(() => {
                      ...
                      return filteredEvents.length > 0 ? (
                        ...
                        const colors = [
                          { bg: 'bg-gray-900', border: 'border-gray-500' },
                          { bg: 'bg-green-900', border: 'border-green-500' },
                          { bg: 'bg-purple-900', border: 'border-purple-500' },
                          { bg: 'bg-yellow-900', border: 'border-yellow-500' }
                        ];
                        const colorSet = colors[index % colors.length];
                        
                        return (
                          <div key={event.id} className="flex gap-3 group">
                            <div className="text-xs text-gray-400 w-16 mt-1">
                              {event.time || 'All Day'}
                            </div>
                        ...
                        <div className="text-center py-8">
                          <div className="text-gray-400 mb-2">No events for this date</div>
                          <button 
                            onClick={() => setShowEventModal(true)}
...
// Project Modal Component (Dark Theme)
function ProjectModalDark({ onClose, onSubmit }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white"
...
// Work Experience Modal Component (Dark Theme)
function WorkExperienceModalDark({ onClose, onSubmit }) {
  const [title, setTitle] = useState("");
  const [link, setLink] = useState("");
...
// Event Modal Component (Dark Theme)
function EventModalDark({ onClose, onSubmit }) {
  const [title, setTitle] = useState("");
...
// Semester Modal Component (Dark Theme)
function SemesterModalDark({ onClose, onSubmit }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-gray-900 rounded-lg p-6 w-full max-w-md mx-4 border border-gray-700">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-white">Add Semester</h3>
          <button 
            onClick={onClose}
            className="text-gray-400 hover:text-white"
          >
